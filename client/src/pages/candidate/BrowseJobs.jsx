  ...
  useEffect(() => {
    const fetchAllData = async () => {
      try {
        ...
        const fetchedJobs = Array.isArray(raw)
          ? raw
        ...
        if (userRes.data?.savedJobs) {
          const savedIds = userRes.data.savedJobs.map((job) =>
          ...
          <div className="relative w-full max-w-md">
            ...
            <input
              ...
              onChange={async (e) => {
                ...
                try {
                  const res = await API.get(`/jobs/search?query=${value}`);
                  setJobs(res.data); // 🔥 overwrite jobs with ES result
                } catch (err) {
        ...
        <div className="flex-1 overflow-y-auto p-8">
          <div className="mb-6">
            ...
            <p className="text-gray-500 text-sm mt-1">
              Browse and apply to the best roles tailored for you.
            </p>
          </div>
